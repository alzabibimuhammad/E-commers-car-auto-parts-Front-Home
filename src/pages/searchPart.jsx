...
const SearchPart = () => {
  ...
  useState(() => {
    fetch("http://127.0.0.1:8000/api/searchPart?carType="+localStorage.getItem('search_part_carType')+"&model="+localStorage.getItem('search_part_model')+"&category="+localStorage.getItem('search_part_category'))
      .then((data) => data.json())
